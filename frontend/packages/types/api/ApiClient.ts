...
import { MiloPromptsService } from './services/MiloPromptsService';
...
export class ApiClient {
    ...
    public readonly miloPrompts: MiloPromptsService;
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = FetchHttpRequest) {
        ...
        this.miloPrompts = new MiloPromptsService(this.request);
        ...
        this.systemConfig = new SystemConfigService(this.request);
