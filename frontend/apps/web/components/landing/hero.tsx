...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-20 sm:pt-24 lg:pt-32 pb-8 sm:pb-12 lg:pb-16" data-hero-section>
      <div className="absolute top-0 right-0 w-48 h-48 sm:w-64 sm:h-64 lg:w-96 lg:h-96 rounded-full blur-3xl opacity-30" style={{ backgroundColor: '#bea45666' }}></div>
      <div className="absolute bottom-0 left-0 w-48 h-48 sm:w-64 sm:h-64 lg:w-96 lg:h-96 rounded-full blur-3xl opacity-20" style={{ backgroundColor: '#bea45680' }}></div>

      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 mb-8 sm:mb-12 lg:mb-16">
        <div className="mb-6 sm:mb-8">
          <span className="inline-block px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-semibold mb-4" style={{ backgroundColor: '#bea4561a', color: '#bea456' }}>
            ✨ EVERYTHING YOU NEED IN ONE PLACE
          </span>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black leading-tight relative">
            <span className="bg-clip-text text-transparent" style={{ backgroundImage: 'linear-gradient(to right, #1f2937, #bea456, #1f2937)' }}>
              The Smartest Way
            </span>
            <br />
            <span className="relative inline-block">
              <span className="text-black">to Show Up</span>
              <span className="ml-2 sm:ml-3 relative" style={{ color: '#bea456' }}>
                Online
                <svg className="absolute -bottom-1 sm:-bottom-2 left-0 w-full" height="8" viewBox="0 0 150 12" fill="none">
                  ...
                  <defs>
                    <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                      <stop offset="0%" stopColor="#bea456" />
                      <stop offset="50%" stopColor="#af9442ff" />
                      <stop offset="100%" stopColor="#bea456" />
                    </linearGradient>
                  </defs>
                </svg>
              </span>
