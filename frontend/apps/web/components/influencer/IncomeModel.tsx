...
const IncomeModel = () => {
  return (
    <Container className="bg-gradient-to-b from-brand to-white">
      <h1 className="text-white text-4xl font-bold max-w-xl">
        Earn While You Learn — Simple, Transparent, Real
      </h1>
      <div className="flex gap-10 mt-10">
        <div className="w-1/2 rounded-lg bg-white shadow-lg p-5 flex flex-col gap-4">
          ...
          <p className="text-sm text-gray-500">
            No tiers, no confusion. Just $30 for every affiliate who joins your
            community.
          </p>
        </div>
        <div className="w-1/2 rounded-lg bg-white shadow-lg p-5 flex flex-col gap-4">
