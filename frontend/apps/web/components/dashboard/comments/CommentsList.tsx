  ...
  if (!comments || comments.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <button
          onClick={onRefresh}
          className="inline-flex items-center gap-2 px-4 py-2 text-white rounded-lg transition-colors" style={{ backgroundColor: '#bea456' }}
        >
    ...
    <>
      <div className="space-y-4">
        {comments.map((comment) => (
          ...
          >
            {/* User Avatar */}
            <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: 'linear-gradient(135deg, #bea456 0%, #af9442ff 100%)' }}>
