    ...
    <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10 sm:mb-12 lg:mb-16">
          <span className="text-purple-500 font-semibold text-xs sm:text-sm uppercase tracking-wider">THE SOLUTION</span>
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 lg:p-12 shadow-sm">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-4 sm:mb-6">
              <span className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 bg-purple-100 text-purple-600 rounded-full text-xs sm:text-sm font-semibold">
                WIN-WIN OPPORTUNITY
              </span>
            </div>
