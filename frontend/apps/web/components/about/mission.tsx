    ...
    <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10 sm:mb-12 lg:mb-16">
          <span className="font-semibold text-xs sm:text-sm uppercase tracking-wider" style={{ color: '#bea456' }}>THE SOLUTION</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-black leading-relaxed mb-4 sm:mb-6">
                I was tired of using <span style={{ color: '#bea456' }}>10+ tools</span> and{' '}
                <span style={{ color: '#bea456' }}>50 browser tabs</span> just to run my business and help my clients scale.
              </h3>
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 lg:p-12 shadow-sm">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-4 sm:mb-6">
              <span className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-semibold" style={{ backgroundColor: '#bea4561a', color: '#bea456' }}>
                WIN-WIN OPPORTUNITY
              </span>
            </div>
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-4 sm:mb-6">
              ...
              <span style={{ color: '#bea456' }}>recurring income every month</span>{' '}
