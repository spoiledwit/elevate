...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-32 pb-16" data-hero-section>
      <div className="absolute top-0 right-0 w-96 h-96 bg-purple-200 rounded-full blur-3xl opacity-30"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-300 rounded-full blur-3xl opacity-20"></div>

      <div className="max-w-4xl mx-auto px-8 text-center relative z-10 mb-16">
        <div className="mb-8">
          <span className="inline-block px-4 py-2 bg-purple-100 text-purple-600 rounded-full text-sm font-semibold mb-4">
            ✨ EVERYTHING YOU NEED IN ONE PLACE
          </span>
          <h1 className="text-6xl md:text-7xl font-black leading-tight relative">
            ...
            <span className="relative inline-block">
              ...
              <span className="text-purple-500 ml-3 relative">
                Online
                <svg className="absolute -bottom-2 left-0 w-full" height="12" viewBox="0 0 150 12" fill="none">
