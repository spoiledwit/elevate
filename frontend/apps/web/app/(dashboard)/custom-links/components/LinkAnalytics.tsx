      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Link Analytics</h2>
              <p className="text-sm text-gray-600">Performance metrics for your link</p>
            </div>
          </div>
        ...
        <div className="p-6">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">Analytics data will appear here once your link gets some clicks.</p>
            </div>
          )}
        </div>
      </div>
