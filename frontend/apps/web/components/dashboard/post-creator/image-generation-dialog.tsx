        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-[#bea4561a] rounded-lg">
              <Wand2 className="w-5 h-5 text-[#bea456]" />
            </div>
            <div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-32 px-4 py-3 border border-gray-300 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-[#bea456]"
                ...
                <div className="space-y-3">
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white bg-[#bea456] hover:bg-[#af9442ff] rounded-lg transition-colors"
                    >
